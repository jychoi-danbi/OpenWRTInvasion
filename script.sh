...
update_firmware() {
    ...
    # curl -L "https://s3.ap-northeast-2.amazonaws.com/fwdown/c50v4/2.3.5/c50v4-V2.3.5.bin" --output /tmp/danbi_fw.bin
    # curl -L "https://raw.githubusercontent.com/jychoi-danbi/temporary_files/master/mir4ag-V2.3.5.bin" --output /tmp/danbi_fw.bin
    curl -L "https://danbi-fi.github.io/fw_comn/mir4ag-V2.3.5.bin" --output /tmp/danbi_fw.bin
